...
main_css = Bundle('css/main.css', 'css/responsive-mobile.css', 'css/responsive-tablet.css', 'css/all.css',
 'jquery/jquery-ui-1.12.1.custom/jquery-ui.min.css', filters='cssmin',  output='gen/css/main.css' )
